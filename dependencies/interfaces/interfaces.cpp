...
void interfaces::initialize( ) {
	...
	input = *(i_input**)(utilities::game::capture_interface("inputsystem.dll", "InputSystemVersion001"));
	...
	globals = **reinterpret_cast< c_global_vars_base*** > (utilities::pattern_scan(GetModuleHandleA("client.dll"), "A1 ? ? ? ? 5E 8B 40 10") + 1); 
